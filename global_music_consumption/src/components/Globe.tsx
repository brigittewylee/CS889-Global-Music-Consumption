...
// 4. The following portions were written with help from AI: Adding UnrealBloompass, fetching and loading in data in the proper format, filtering data for import/export datasets, 
// and rotating globe for point of view (Disclaimer: I'm actually not sure where the conversation for this code was, I think I accidentally deleted it or it was on another chat after my 
// credits ran out but it was based off code generated by Claude. I basically prompted it with the first portion of my code including the globeref values and used Render Control methods 
// from the official GlobeGL site: https://globe.gl/ to implement lines 160-164. I tried to get the same result by prompting claude again but it didn't really work well since it already saw
